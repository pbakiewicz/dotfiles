...
k("n", "<F4>", "<Cmd>lua require'dap'.step_out()<CR>", opts)
k("n", "<F6>", "<Cmd>lua require'dap'.continue()<CR>", opts)
k("n", "<F7>", "<Cmd>lua require'dap'.set_breakpoint(vim.fn.input('Podaj warunek: '))<CR>", opts)
k("n", "<F9>", "<Cmd>lua require'dapui'.eval(vim.fn.input 'Co zevaulować? ')<cr>", opts)
k("n", "<F10>", "<Cmd>lua require'dap'.repl.toggle()<CR>", opts)
k("n", "<F11>", "<Cmd>lua require'dapui'.toggle()<CR>", opts)
